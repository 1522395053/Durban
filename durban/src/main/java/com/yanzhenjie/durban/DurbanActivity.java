...
public class DurbanActivity extends AppCompatActivity {
    ...
    private void initArgument(Intent intent) {
        ...
        if (TextUtils.isEmpty(mTitle)) mTitle = getString(R.string.durban_TitleCrop);
    ...
    private void initContentViews() {
        ...
        overlayView.setDimmedColor(ContextCompat.getColor(this, R.color.durban_ColorDimmed));
        overlayView.setCircleDimmedLayer(false);
        overlayView.setShowCropFrame(true);
        overlayView.setCropFrameColor(ContextCompat.getColor(this, R.color.durban_ColorCropFrame));
        ...
        overlayView.setCropGridColor(ContextCompat.getColor(this, R.color.durban_ColorCropGrid));
